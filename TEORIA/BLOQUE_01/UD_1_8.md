...
# 📝 ACTIVIDAD FINAL BLOQUE 01 - **`b1_10_login.py`**

## 🎯 Objetivos de aprendizaje

* Poner en práctica **todos los conceptos aprendidos en este bloque**: variables, tipos de datos, operadores, condicionales, bucles, control de flujo, buenas prácticas y depuración.
...
---
Para esta actividad se pide, crear un sistema de **registro e inicio de sesión** con validación de contraseñas seguras, simulando de forma sencilla el funcionamiento de apps reales.
...
2. **Registro de usuario:**
   ...
   * La información del usuario se almacenará en variables:
     ...
     * **identifer** es el email del usuario de usuario.
...
* Usa **estructuras de control** para evitar código duplicado:

  * Mantener el menú activo hasta que se seleccione la opción de salir.
