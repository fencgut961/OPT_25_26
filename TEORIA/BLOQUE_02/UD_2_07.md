...
## 📝 Actividad guiada — `diccionario_crud.py`

### 📘 Descripción
Esta es una **plantilla base** para crear un programa **CRUD (Create, Read, Update, Delete)** en Python,  
usando un **diccionario** para almacenar la información de las personas y la estructura moderna de control **`match-case`** (disponible desde Python 3.10).

Cada persona se guarda con un **DNI (ID)** como clave única, y el valor asociado es otro diccionario con los siguientes datos:
...
- Mostrar todas las personas registradas (**Read**)
- Actualizar datos existentes (**Update**)
- Eliminar una persona por su ID (**Delete**)
- Navegación mediante menú con `match-case`
